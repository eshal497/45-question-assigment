...
var personName = 'thankful note';
var message = 'governer sindh kamran khan tessori';
console.log(`${personName} to ${message}`);
//Task 11
//Array work like a variable 
let names = ["Emily", "Ryan", "Piper", "Kevin"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
//Task 12
let name = ["Emily", "Ryan", "Piper", "Kevin"];
...
//Task 16
let guestArr = ["Allison", "Harry", "Terry", "Jennie"];
let canNotAttend = "Harry";
let newGuest = "Meghan";
guestArr[guestArr.indexOf(canNotAttend)] = newGuest;
console.log(guestArr);
...
let guests = ["Maddison", "Nia", "Celine", "Abby"];
...
//Task 19
let invitation = ["Marie Curie", "Leonardo da Vinci", "Charles Darwin"];
...
//Task 21
let person = { name: "Eshal", fname: "Female", age: 16 };
console.log(person);
//Task 22
const days = ["Sunday", "Monday", "Tuesday", "Thursday", "Friday", "Saturaday"];
console.log(days[6]);
//Task 23
let car = 'subaru';
...
//Task 24
let name1 = 'Eshal';
let name2 = 'Eshal Khan';
let name3 = 'Eshal khan';
if (name1 != name3) {
...
//Task 29
let favorite_fruits = ["orange", "apple", "grapes"];
...
//Task 32
let current_users = ['eman', 'noor', 'wahiba', 'john', 'micheal'];
let new_user = ["admin", "eric", "john", "micheal", "david"];
...
//Task 34
let favorite_Pizzas = ['fajita', 'bbq flavor', 'white sause and cheese'];
...
const magicians = ['Harry Houdini', 'David Copperfield', ' David Blaine', 'Uri Geller'];
